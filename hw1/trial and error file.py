# -*- coding: utf-8 -*-
"""
Created on Mon Mar 12 19:04:13 2018
...
while True:
    mycom=input("請輸入命令 a前進 b偵測 c看數據 d交換 e離開: ")
    if mycom == "a":
...
#                            cont=input("是否繼續挑戰? (y/n): ")  
                ...
                if reward=="1":
                    ...
                    if r==0:
                        ...
                        print("友善生命體覺得你太客氣了 所以都給你")
                        s=s+1
                        hp+=1
                        e+=15
                    else:
                        print("友善生命體因為你受傷了 遭到攻擊")
                        print("扣5能量")
                        e=e-5
                stats()
                if e<=0:
            ...
            if z==0:
                ...
                if w==0:
                    print("成功抵達那美克星")
                    print("那美克星人可以幫助您增加15能量或1顆星!")
                    ask=input("請選擇增加 1.能量 2.星星: ")
                    while ask!="1" and ask!="2":
                        ask=input("請選擇增加 1.能量 2.星星: ")
                    if ask=="1":
                        print("那美克星人幫助您增加15點能量了!")
                        e=e+15
                    else:
                        print("那美克星人幫助您增加1顆星了!")
                        s=s+1
                else:
                    print("成功抵達賽亞星")
                    print("賽亞人可以幫助您增加1HP或1顆星!")
                    ask=input("請選擇增加 1.HP 2.星星: ")
                    while ask!="1" and ask!="2":
                        ask=input("請選擇增加 1.能量 2.星星: ")
                    if ask=="1":
                        print("賽亞人幫助你增加1HP了!")
        ...
        print("可使用星星換HP或能量")
        print("一顆星星可以換15能量或2HP")
        if s<=0:
            print("因為星星數不夠多,不能交換")
        else:
            ask=input("請問一顆星星換 1.能量 2.HP 3.取消: ")
            while ask!='1' and ask!='2' and ask!='3':
                ask=input("請問一顆星星換 1.能量 還是 2.HP 3.取消: ")
            if ask=='1':
                s=s-1
                e=e+15
            elif ask=='2':
